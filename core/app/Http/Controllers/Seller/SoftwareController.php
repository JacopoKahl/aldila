...
class SoftwareController extends Controller
{
	...
	public function store(Request $request)
	{
		$request->validate([
            ...
            'document' => ['required', 'image', new FileTypeValidate(['pdf'])],
            'uploadSoftware' => ['required', 'image', new FileTypeValidate(['zip'])],
        ]);
        $user = Auth::user();
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'url' => 'required|url',
            'description' => 'required',
            'document' => ['nullable', 'image', new FileTypeValidate(['pdf'])],
            'uploadSoftware' => ['nullable', 'image', new FileTypeValidate(['zip'])],
        ]);
        $user = Auth::user();
        $general = GeneralSetting::first();
