                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                <label for="value" class="form-control-label font-weight-bold">@lang('Search Max Value')</label>
                                <div class="input-group mb-3">
                                      <input type="text" id="value" class="form-control form-control-lg" placeholder="@lang('Enter Amount')" name="searchMax" value="{{getAmount($general->search_max)}}" aria-label="Recipient's username" aria-describedby="basic-addon2" required="">
                            ...
                            <div class="col-md-3 form-group">
                                <label for="value" class="form-control-label font-weight-bold">@lang('Charge')</label>
                                <div class="input-group mb-3">
                                      <input type="text" id="value" class="form-control form-control-lg" placeholder="@lang('Enter Amount')" name="charge" aria-label="Recipient's username" value="{{getAmount($general->charge)}}" aria-describedby="basic-addon2" required="">
                                      <div class="input-group-append">
                                        <span class="input-group-text" id="basic-addon2">{{$general->cur_text}}</span>
                                      </div>
                                </div>
                        ...
                        <div class="row">
                             <div class="form-group col-md-3">
                                <label class="form-control-label font-weight-bold">@lang('Approval Post Auto')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" name="approval_post" @if($general->approval_post) checked @endif>
                            </div>
